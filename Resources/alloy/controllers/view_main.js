function Controller() {
    ...
    $.__views.__alloyId78.add($.__views.viewTop);
    ...
    $.__views.view_left.add($.__views.__alloyId79);
    ...
    $.__views.view_right.add($.__views.__alloyId80);
    ...
    $.__views.viewContent.add($.__views.__alloyId81);
    $.__views.vv1 = Ti.UI.createView({
        id: "vv1",
        layout: "horizontal"
    });
    $.__views.__alloyId81.add($.__views.vv1);
    ...
    $.__views.vv1.add($.__views.__alloyId82);
    ...
    $.__views.__alloyId81.add($.__views.vv2);
    ...
    $.__views.vv2.add($.__views.__alloyId85);
    ...
    $.__views.viewContent.add($.__views.__alloyId88);
    $.__views.vv3 = Ti.UI.createView({
        id: "vv3",
        layout: "horizontal"
    });
    $.__views.__alloyId88.add($.__views.vv3);
    ...
    $.__views.vv3.add($.__views.__alloyId89);
    ...
    $.__views.vv4.add($.__views.__alloyId92);
    ...
    $.__views.vv5.add($.__views.__alloyId95);
    ...
    $.__views.__alloyId98.add($.__views.content);
    $.__views.backBtn = Ti.UI.createImageView({
        id: "backBtn"
    });
    $.__views.__alloyId98.add($.__views.backBtn);
