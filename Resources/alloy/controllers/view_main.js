function Controller() {
    ...
    $.__views.__alloyId45.add($.__views.viewTop);
    ...
    $.__views.view_left.add($.__views.__alloyId46);
    ...
    $.__views.view_right.add($.__views.__alloyId47);
    ...
    $.__views.__alloyId45.add($.__views.scrollView);
    ...
    $.__views.__alloyId48.add($.__views.vv1);
    ...
    $.__views.vv1.add($.__views.__alloyId49);
    ...
    $.__views.__alloyId48.add($.__views.vv2);
    ...
    $.__views.vv2.add($.__views.__alloyId52);
    ...
    $.__views.viewContent.add($.__views.__alloyId55);
    $.__views.vv3 = Ti.UI.createView({
        id: "vv3",
        layout: "horizontal"
    });
    $.__views.__alloyId55.add($.__views.vv3);
    ...
    $.__views.vv3.add($.__views.__alloyId56);
    ...
    $.__views.vv4.add($.__views.__alloyId59);
    ...
    $.__views.vv5.add($.__views.__alloyId62);
    ...
    __alloyId44.push($.__views.__alloyId65);
    ...
    $.__views.__alloyId65.add($.__views.backBtn);
