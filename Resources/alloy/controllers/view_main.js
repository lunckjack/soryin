function Controller() {
    ...
    $.__views.__alloyId43.add($.__views.viewTop);
    ...
    $.__views.view_left.add($.__views.__alloyId44);
    ...
    $.__views.view_right.add($.__views.__alloyId45);
    ...
    $.__views.__alloyId43.add($.__views.scrollView);
    ...
    $.__views.viewContent.add($.__views.__alloyId46);
    $.__views.vv1 = Ti.UI.createView({
        id: "vv1",
        layout: "horizontal"
    });
    $.__views.__alloyId46.add($.__views.vv1);
    ...
    $.__views.vv1.add($.__views.__alloyId47);
    ...
    $.__views.__alloyId46.add($.__views.vv2);
    ...
    $.__views.vv2.add($.__views.__alloyId50);
    ...
    $.__views.viewContent.add($.__views.__alloyId53);
    $.__views.vv3 = Ti.UI.createView({
        id: "vv3",
        layout: "horizontal"
    });
    $.__views.__alloyId53.add($.__views.vv3);
    ...
    $.__views.vv3.add($.__views.__alloyId54);
    ...
    $.__views.vv4.add($.__views.__alloyId57);
    ...
    $.__views.vv5.add($.__views.__alloyId60);
    ...
    __alloyId42.push($.__views.__alloyId63);
    ...
    $.__views.__alloyId63.add($.__views.backBtn);
