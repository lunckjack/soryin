function Controller() {
    ...
    $.__views.__alloyId67.add($.__views.viewTop);
    ...
    $.__views.view_left.add($.__views.__alloyId68);
    ...
    $.__views.view_right.add($.__views.__alloyId69);
    ...
    $.__views.viewContent.add($.__views.__alloyId70);
    $.__views.vv1 = Ti.UI.createView({
        id: "vv1",
        layout: "horizontal"
    });
    $.__views.__alloyId70.add($.__views.vv1);
    ...
    $.__views.vv1.add($.__views.__alloyId71);
    ...
    $.__views.__alloyId70.add($.__views.vv2);
    ...
    $.__views.vv2.add($.__views.__alloyId74);
    ...
    $.__views.viewContent.add($.__views.__alloyId77);
    $.__views.vv3 = Ti.UI.createView({
        id: "vv3",
        layout: "horizontal"
    });
    $.__views.__alloyId77.add($.__views.vv3);
    ...
    $.__views.vv3.add($.__views.__alloyId78);
    ...
    $.__views.vv4.add($.__views.__alloyId81);
    ...
    $.__views.vv5.add($.__views.__alloyId84);
    ...
    __alloyId66.push($.__views.__alloyId87);
    $.__views.content = Ti.UI.createView({
        id: "content"
    });
    $.__views.__alloyId87.add($.__views.content);
    $.__views.backBtn = Ti.UI.createImageView({
        id: "backBtn"
    });
    $.__views.__alloyId87.add($.__views.backBtn);
