function Controller() {
    ...
    $.__views.__alloyId49.add($.__views.tab);
    ...
    $.__views.tab1.add($.__views.__alloyId50);
    ...
    $.__views.__alloyId50.add($.__views.l2);
    $.__views.l1 = Ti.UI.createLabel({
        text: "描述",
        id: "l1"
    });
    $.__views.__alloyId50.add($.__views.l1);
    ...
    $.__views.tab2.add($.__views.__alloyId51);
    ...
    $.__views.__alloyId51.add($.__views.l4);
    $.__views.l3 = Ti.UI.createLabel({
        text: "图片",
        id: "l3"
    });
    $.__views.__alloyId51.add($.__views.l3);
